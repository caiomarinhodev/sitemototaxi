...
/**/
object splay extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {
...
<html>
    ...
    <body>
        ...
        <script>
        $(document).ready(function() """),format.raw/*391.38*/("""{"""),format.raw/*391.39*/("""
        """),format.raw/*392.9*/("""setTimeout("location.reload(true);",5000);
        """),format.raw/*393.9*/("""}"""),format.raw/*393.10*/(""" """),format.raw/*393.11*/(""");
        </script>
    </body>
    """),format.raw/*396.5*/("""}"""),format.raw/*396.6*/("""
"""),format.raw/*397.1*/("""</html>"""))}
  }
